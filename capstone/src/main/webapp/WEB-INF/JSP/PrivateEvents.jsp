...
<h3 style="text-align: center; color: white;">Exclusive Wine Tasting Event</h3>
<!-- The video -->
<video autoplay muted loop id="myVideo">
    <source src="../../public/Videos/WineTasting.mp4" type="video/mp4">
</video>
<h3 style="text-align: center; color: white;">Event Overview</h3>

<%--**Date:** [Insert Date]--%>
<%--**Time:** [Insert Time]--%>
<%--**Location:** [Insert Venue], [Insert Address]--%>

<h4 style="text-align: center; color: white;">Event Description</h4>

<p style="text-align: center; color: red;">We are delighted to invite you to an exclusive wine tasting event, designed for a select group of connoisseurs and enthusiasts. This intimate gathering promises an exquisite journey through a curated selection of fine wines, offering a unique opportunity to savor and explore a variety of exceptional vintages.
</p>
